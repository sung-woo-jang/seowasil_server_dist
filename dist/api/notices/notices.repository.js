...
let NoticesRepository = class NoticesRepository extends typeorm_1.Repository {
};
NoticesRepository = __decorate([
    (0, typeorm_1.EntityRepository)(notice_entity_1.Notice)
], NoticesRepository);
